...
Dada uma condição inicial $(p, w)$ ($w$ [[Restrição Orçamentária|Renda]]), e uma demanda walrasiana $x^*(p, w)$, o efeito preço é calculado pela [[Equação de Slutsky]],
$$
\frac{ \partial x^* }{ \partial p } = \frac{ \partial h }{ \partial p } - x^* \frac{ \partial x^* }{ \partial w } 
$$
onde $h(p, \bar{u})$ é a [[Demanda Hicksiana]], $\frac{ \partial h }{ \partial p }$ é o [[Efeito Substituição]] e $x^* \frac{ \partial x^* }{ \partial w }$ é o [[Efeito Renda]]. 
