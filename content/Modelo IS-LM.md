...
- Preços são *rígidos*[^2]
- O [[Produto Agregado]] é determinado pela [[Despesa Agregada|Demanda Agregada]] (essencialmente [[Lei de Say]])
...
A redução do [[Consumo Autônomo]] $c_{0}$ (*ceteris paribus*) se traduz num corte nas despesas "mínimas"[^3] e, portanto, numa redução da produção. Induz, portanto, uma menor taxa de juros, a fim de instigar investimentos para repô-la.
...
Fonte: BLANCHARD, JOHNSON, p. 97. Os termos $\frac{M}{P}$ são medidas da "riqueza real", que são quantidades que o [[Banco Central]] pode alterar através da compra/venda de ativos/títulos[^5].
...
[^1]: [[Taxa Real de Juros]], caso se considere também [[Inflação]]. Tem de ser a taxa *real*, pois temos um equilíbrio no mercado de *bens* (e no de ativos também é pertinente). 
[^2]: Ou, no mínimo, há uma "*rigidez para baixo*" dos [[Salário]]s. 
[^3]: Ou num sentido de que o público *sente* que possui menos riqueza e, portanto, reduz seu consumo, cf. [[Efeito Riqueza]].
[^4]: Supondo [[Modelo Keynesiano Simples]].
[^5]: É verdadeiro isso? Parece conflitar com [[Neutralidade da Moeda]].
