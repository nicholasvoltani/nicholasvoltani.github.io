...
Ou seja, dados os retornos (e.g.) anuais $\{ Q_{i} \}_{i=1}^{N}$ de algum capital, temos que a eficiência marginal deste capital é a taxa de desconto que faz com que
$$
...
# $EMgK$ depende do rendimento *total* do capital
...
# Influências em $EMgK$
Note-se que o **aumento no [[Investimentos|Investimento]]** em certo capital vai
...
# Distinções entre $EMgK$ e taxa de juros
