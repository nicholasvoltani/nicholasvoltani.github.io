...
up:: [[069a MOC Sistema Financeiro Nacional]]

# Regulação do Sistema Financeiro Nacional
1) Constituição Federal
2) **Leis Complementares** (requerem *maioria* [não só de presentes] do Congresso e do Senado)
3) Normas Infralegais (e.g. circulares/resoluções do Bacen)

## Níveis de regulação do SFN (Artigo 192)
1) **Normatizadores**: estabelecem as regras (e.g. Conselho Monetário Nacional)
2) **Supervisores**: detalham regras e asseguram cumprimento  (e.g. [[Banco Central]])
3) **Operadores**: atuam diretamente no mercado financeiro, junto ao público (e.g. bancos \[p. ex. Banco do Brasil\], cooperativas de crédito)

## Ramos/Mercados do SFN
1) **Financeiro**
	1) Mercado Monetário: fornece papel moeda (física) & moeda escritural (não existe fisicamente)
		1) Bancos atuam neste mercado quando "compram dinheiro" através de títulos públicos
	2) Mercado de Crédito: recursos para [[Consumo Agregado|Consumo]] e funcionamento de empresas ([[Investimentos]])
	3) Mercado de Capitais: recursos para projetos de *longo prazo* de empresas (p. ex. [[Debênture|Debêntures]])
	4) Mercado de Câmbio: compra/venda de moeda estrangeira
2) **Seguros**
3) **Previdência**
...
- Instância máxima **decisória**[^2] do SFN
- **Elabora/Formula** [[Política Monetária|Políticas Monetárias]] e de crédito, para estabelecer estabilidade da moeda & desenvolvimento econômico
...
É executor de [[Política Monetária|Políticas Monetárias]]: determina quantidade de moeda em circulação, conforme determinações do CMN. Hoje em dia (pós-2023?), CMN aprova o Orçamento Monetário, mas BCB tem autonomia quanto à emissão de moeda. (?)
...
| Ativos<br>(aplicações)                                                                                                                                                             | Passivos<br>(captações)                                                                                    | Principais Operações                                                                                                         |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| Financiamentos de capital de giro e [[Capital Fixo]];<br>subscrição/aquisição de títulos/valores *imobiliários*;<br>depósitos interfinanceiros;<br>repasses empréstimos *externos* | [[Depósito a Prazo]];<br>repasses de *recursos* externos;<br>venda de cotas de fundos de investimentos (?) | Suprimento de capital fixo e de giro e administração de recursos de terceiros, através de participação societária temporária |
...
| Ativos<br>(aplicações)                                                                                                               | Passivos<br>(captações)                                                                   | Principais Operações                                          |
| ------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------- | ------------------------------------------------------------- |
| empréstimos e financiamentos ao setor privado (princ.), médio/longo prazo, em projetos de desenvolvimento econômico/social do estado | [[Depósito a Prazo]];<br>empréstimos externos;<br>emissão/endosso de cédulas hipotecárias | Empréstimos e financiamentos ao setor privado principalmente. |
## Bancos de Câmbio

| Ativos<br>(aplicações)                            | Passivos<br>(captações)                                                                                                                                                                     | Principais Operações                                                                                                                                                                                         |
| ------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Operações de câmbio e crédito vinculado ao câmbio | Depósitos em contas sem remuneração, não-movimentáveis por cheque/meio eletrônico pelo titular;<br>repasses interbancários;<br>depósitos interfinanceiros;<br>recursos captados do exterior | Compra e venda de moeda estrangeira; <br>transferência de recursos do/para o exterior;<br>financiamento de [[Importações]] e [[Exportações]];<br>adiantamento de [[Contrato de Câmbio\|contratos de câmbio]] |
...
[^1]: Circulares do Bacen hoje também são chamadas de resoluções, então não confundir.
[^2]: Não recursal; atua de forma *geral*, não específica.
[^3]:  BNDES **não é controlado por governo *estadual***, e sim **federal**.