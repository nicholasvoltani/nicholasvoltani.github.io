...
![[Pasted image 20250507105703.png|500]]
Fonte: [Understanding research philosophies and approaches (SAUNDERS, LEWIS, THORNHILL, 2009)](https://www.researchgate.net/figure/Critical-realist-stratified-ontology-Source-Developed-from-Bhaskar-1978_fig1_309102603)

A dimensão empírica da realidade é a dimensão mais imediata a nós. Consiste no que é *observável diretamente* no mundo, ou seja, naqueles fenômenos que *se efetivaram na realidade*, em *experiências*.

Subjacente a ela está a [[Dimensão Efetiva da Realidade]], de fenômenos — ditos *eventos* — que podem ser observáveis *ou não*, mas que, ainda assim, são "reais", são *efetivos*. 

Na base está a [[Dimensão Real da Realidade]], que dita as estruturas causais e mecanismos subjacentes dos fenômenos, efetivem-se eles ou não. 
