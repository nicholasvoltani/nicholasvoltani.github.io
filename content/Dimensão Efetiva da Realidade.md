...
A dimensão efetiva da realidade consiste no conjunto de *eventos*, que podem ou não serem observáveis, mas que são, não obstante, efetivos, "reais".

Aqueles que são imediatamente observáveis — i.e. são *experiências* — pertencem à [[Dimensão Empírica da Realidade]]. 

Subjacente está a [[Dimensão Real da Realidade]], na qual jazem os mecanismos e estruturas causais que ditam a ocorrência e propriedades dos fenômenos.
