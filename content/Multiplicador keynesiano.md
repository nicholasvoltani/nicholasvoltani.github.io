...
Dado o [[Modelo Keynesiano Simples]] de [[Consumo Agregado]] como função linear da [[Renda Privada Disponível]] $Y_{D}$,
$$
C(Y_{D}) = c_{0} + c_{1} Y_{D} = c_{0} + c_{1}(Y-T)
$$
...
Caso assuma-se que $T = tY$, o multiplicador terá a forma
$$
\frac{1}{1-c_{1}(1-t)}
$$
Numa economia *aberta*, assumindo que $M = mY$ e $T=tY$, tem-se que
$$
Y = \frac{1}{1-c_{1}(1-t) + m} (c_{0}+I+G+X)
$$
