...
# I) VFT variável, *ceteris paribus*
Suponha-se que o valor dos meios de subsistência da [[Força de Trabalho]] varia. Junto dessa variação, muda também o valor da própria força de trabalho e, por consequência, dos produtos produzidos por ela. Gera-se, portanto, [[Mais-Valor Relativo]].

Ou seja, há uma mudança relativa do [[Tempo de Trabalho Socialmente Necessário]] na produção de uma [[Mercadoria]] qualquer frente a seu [[Tempo Excedente de Trabalho]], numa [[Jornada de Trabalho]] fixa & intensidade do trabalho fixa também.

Contudo, **o valor produzido nesta jornada de trabalho ainda é o mesmo**! O que muda é a quantidade de trabalho não-pago!

# II) Intensidade do trabalho variável, *ceteris paribus*
> "Já no ganho de intensidade, o trabalho em excesso comprimido na jornada equivale ao trabalho normal realizado em uma jornada mais longa. Por isso, ele cria valor *como se* a jornada tivesse sido, de fato, prolongada. Nesse caso, ao contrário do que vimos para o ganho de produtividade, o tempo de trabalho excedente pode aumentar mesmo sem que haja reduções no tempo de trabalho necessário. O valor novo criado e o mais-valor crescem porque a quantidade de trabalho excedente cresceu." (Sá Barreto, 2022, p. 62)

A mudança da intensidade do trabalho faz com que, numa dada JT, produza-se uma quantidade maior de produtos **mediante maior condensação do trabalho** — e, por consequência, um consumo maior de meios de produção. Ou seja, uma jornada de trabalho de algum capital particular vai equivaler *mais* de uma jornada de trabalho **normal**. 
