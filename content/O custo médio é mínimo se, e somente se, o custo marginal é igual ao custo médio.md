...
$$
onde, para o $q^{*}$ encontrado acima, resta somente $\frac{1}{q} \frac{d^{2}C}{dq^{2}}$, que é positivo devido aos custos variáveis. Portanto, $q^{*}$ trata-se de um ponto de mínimo.
