...
Os trabalhos são tornados abstratos pela generalização da forma-mercadoria, ou seja, pela generalização da [[Processo de Troca de Mercadorias|Relação de Troca]] de produtos do trabalho *enquanto mercadorias*, i.e. quando eles são produzidos *com o propósito de serem vendidos*[^2], quando sua produção *já pressupõe* o caráter abstrato de seu trabalho particular (que só será aferido enquanto trabalho *social*, remetendo a seu caráter abstrato, justamente, na troca).
...
As características dos [[Trabalho|trabalhos]] que criaram as mercadorias aparecem-lhes como características intrínsecas e naturais, objetivas:
...
Ou seja, dentro do contexto de troca, tem-se a percepção de que é possível proceder sem a percepção de que esteja travando-se uma relação *social*, *humana*: quer-se uma certa mercadoria, obtida por trocá-la por outra, e fim, "mais nada". 
 %%
...
---
### Referências
- CARCANHOLO, Marcelo Dias. Valor e preço na teoria de Marx: o significado da lei do valor. _In_: MEDEIROS, João Leonardo; SÁ BARRETO, Eduardo (Orgs.). **Para que leiam O capital: interpretações sobre o Livro I**. São Paulo: Usina Editorial, 2021.
