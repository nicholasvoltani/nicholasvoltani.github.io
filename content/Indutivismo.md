...
![[Pasted image 20250221163945.png|400]]
Fonte: [The flow diagrams of inductive and deductive reasoning (Bayazit Karaman)](https://www.researchgate.net/figure/The-flow-diagrams-of-inductive-and-deductive-reasoning_fig2_293336132?__cf_chl_rt_tk=D8hq9UkZ1ApkpYwdcLPojx6mhcC7h0Ba8DDOLNPCqF4-1740166795-1.0.1.1-BYTxW0eOLWZD5KB4036zyE8SIcO06YIfIzbgau5rUCs)
...
1) **Princípio da Acumulação**: O conhecimento é visto como uma soma de fatos/observações conhecidos
2) **Princípio da Indução**: A partir de fatos acumulados, inferem-se leis gerais que os expliquem[^1]
3) **Princípio da Confirmação Instancial** \[Instance Confirmation\]: a plausibilidade de uma teoria aumenta conforme mais instâncias que corroborem uma dada lei induzida sejam encontradas

# Métodos de Mill \[*Mill's Canons*\]
Dentre os principais métodos de (John Stuart) Mill, estão:
1) Método da Concordância (*Canon of Agreement*): quando todos os experimentos (i.e. instâncias de um mesmo fenômeno) *concordam com uma, e somente uma, característica*, então conclui-se que esta característica é causa (ou efeito) deste fenômeno. Pensando em instâncias como conjuntos de características, este método se refletiria matematicamente por uma interseção de características de diferentes instâncias $i$ de um fenômeno: $\bigcap X_{i}$
2) Método da Diferença (*Canon of Difference*): quando comparam-se uma instância de um fenômeno e uma instância em que este fenômeno *não* ocorre, em que *há uma, e somente uma, característica distinta entre eles*, então conclui-se que esta característica é causa (ou efeito) da ocorrência (ou não) do fenômeno. Pensando em instâncias como conjuntos de características, este método se refletiria matematicamente por uma *set difference* entre ambas estas instâncias: $I \setminus (\lnot I)$ 
...
Ademais, não há uma lei unívoca que é induzida a partir de dados, mas sim uma infinidade de possíveis leis que os expliquem. Por exemplo, sempre pode-se obter uma curva que passe perfeitamente por todos os pontos ([Polinômios de Lagrange](https://en.wikipedia.org/wiki/Lagrange_polynomial)), embora não sejam modelos tão adequados cientificamente.

![[Pasted image 20250221164749.png]]
Fonte: Harré, p. 44.

Um princípio auxiliar que costuma-se adicionar é o "Princípio da Simplicidade", pelo qual priorizam-se as teorias mais simples... o que não ajuda muito, pois o modelo mais simples sempre é uma constante, e isso não é um modelo científico útil[^2]. 
...
- [Introduction to Philosophy of Science (Paul Hoyningen-Huene) - YouTube](https://www.youtube.com/playlist?list=PLtvASwaz8fGhIGX2mTYCh6elNUUVYIN_7)
	- [Introduction to Philosophy of Science. Lecture 1, part 1 - YouTube](https://youtu.be/tP8teUgZcBY?list=PLtvASwaz8fGhIGX2mTYCh6elNUUVYIN_7&t=1316)
	- [Introduction to Philosophy of Science. Lecture 1, part 2 - YouTube](https://www.youtube.com/watch?v=dY5ZqxkaaGQ&list=PLtvASwaz8fGhIGX2mTYCh6elNUUVYIN_7&index=3)
	- [Introduction to Philosophy of Science. Lecture 2, part 1 - YouTube](https://www.youtube.com/watch?v=8CN071tAf3g&list=PLtvASwaz8fGhIGX2mTYCh6elNUUVYIN_7&index=4)

[^1]: "As Mach put it, \[laws of nature\] are the *mnemonic reproduction* of facts *in thought*" (Harré, p. 42, grifo meu).
[^2]: Na maior parte das vezes, ao menos. A exceção-mor é a reprodução de constantes da Natureza.
