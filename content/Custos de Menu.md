...
Note-se que esse conceito só faz sentido para [[Monopólio|mercados imperfeitamente competitivos]] (cf. citação acima), pois o mesmo não seria possível para [[Competição Perfeita|Mercado Perfeitamente Competitivos]], devido à [[Elasticidade de Preço da Demanda]] ser perfeitamente elástica ($\Delta p > 0 \implies \Delta q \to 0$; $\Delta p < 0 \implies \Delta q \to \infty$). 
