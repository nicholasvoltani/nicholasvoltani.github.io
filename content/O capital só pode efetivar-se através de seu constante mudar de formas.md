...
Assume a forma de [[Capital-Dinheiro]] para que possa adquirir (na circulação) [[meios de produção]] e [[Força de Trabalho]], [[Mercadoria|Mercadorias]] necessárias para a produção, i.e. sai da esfera da circulação; neste fazer, assume a forma de [[Capital Produtivo]], no qual [[processo de produção capitalista|usufrui produtivamente]] de suas mercadorias e produz mercadorias "prenhes de mais-valor", que precisam ser *vendidas* para que aproprie-se dele; neste fazer, assume a forma de [[Capital-Mercadoria]], que requer que a mercadoria produzida seja vendida, para que seu (mais-)[[valor]] seja efetivado — na [[Forma-Dinheiro]], pronta para ser reinvestida[^1]. E o ciclo continua enquanto puder. 

Enquanto estiver em movimento, é capital. Quando não estiver em movimento, não é capital, no máximo podendo ser capital *latente* *porquanto tenha a possibilidade real de efetivar-se*.
...
[^1]: No mínimo para [[Reprodução Simples do Capital]]; caso (parte de) o mais-valor seja reinvestido, [[Reprodução Ampliada do Capital]].
[^2]: Marx fala, no livro I, do caso de um capitalista que reclama que os trabalhadores, ao reivindicarem momentos de lazer fora do trabalho, ao "abandonar a fábrica, [tornam] inútil um capital [uma máquina] que custou £100.000" (MARX, 2013, p. 478)
[^3]: Na medida do possível, claro, pois (cf. parágrafo seguinte à citação acima) "é natural que o próprio ciclo se encarregue de imobilizar o capital, por certo tempo, nas fases singulares do processo" (ibid.).  Cf. [[Tempo de Circulação do Capital Industrial]]. 