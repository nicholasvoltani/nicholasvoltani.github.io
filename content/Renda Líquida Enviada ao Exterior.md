...
![[Pasted image 20241204150539.png|500]]
Fonte: [Macroeconomia 018 Contabilidade Social - YouTube](https://youtu.be/7yAEnt9d8KA?list=PLT4EcyyDiDfs7KbIdVLwsxmld3yo9S1FW&t=984)

Note que, pela fórmula acima,
$$
\frac{PNB}{PIB} = 1 - \%RLEE \equiv 1 - \frac{RLEE}{PIB}
$$
Portanto, pelo gráfico acima, tem-se que o $\%RLEE$ médio é de $0.025 = 2.5\%$ do PIB. Ou seja, remete-se, em média, $2.5\%$ do PIB para o exterior.
...
- [Macroeconomia 018 Contabilidade Social - YouTube](https://www.youtube.com/watch?v=7yAEnt9d8KA&list=PLT4EcyyDiDfs7KbIdVLwsxmld3yo9S1FW&index=18)