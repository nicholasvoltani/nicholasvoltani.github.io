...
up:: [[011a MOC Capital I]] / [[061 MOC Macroeconomia]]
...
A depreciação de algum [[Meios de Produção|Meio de Trabalho]] trata de seu desgaste diário/mensal/anual etc, até que este meio de trabalho torne-se inutilizável, i.e. até que ele perca seu [[Valor de Uso]] no [[Processo de Trabalho]] a que se presta.

Suponha, por exemplo, que um barril médio para fermentação de vinhos dure 10 anos, desde seu primeiro uso até o ponto em que ele se torna inutilizável para essa função. Então sua depreciação por ano é $\frac{1}{10}$, sua depreciação por mês é $\frac{1}{120}$, etc.
