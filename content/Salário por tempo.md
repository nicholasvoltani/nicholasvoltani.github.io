...
Seja o [[Valor da Força de Trabalho]] diário médio $\bar{v}$, e a [[Jornada de Trabalho]] média $J$. Então o "preço médio do trabalho" (por tempo) $\bar{P}$ é definido como[^1]
$$
\bar{P} = \frac{\bar{v}}{J}
$$

O salário *por tempo* diário $S$ depende, portanto, da quantidade de horas trabalhadas $T$ no dia. É, portanto,
$$
\begin{align}
S &= \bar{P} \cdot T  \\
&= \bar{v} \cdot \frac{T}{J}
\end{align}
$$
Ou seja, pode ser que, não obstante o valor médio $\bar{v}$ esteja em queda, que o salário $S$ mantenha-se constante, mediante aumento da quantidade de horas trabalhadas $T$, *com a jornada de trabalho $J$ constante* – ou seja, assumindo-se que este aumento $\Delta T$ seja algo "anormal" à jornada de trabalho normal, estabelecida[^2]. 

> "Conclui-se, como lei geral: estando dada a quantidade de trabalho diário, semanal etc." (i.e. $T$), "o salário diário ou semanal dependerá do preço do trabalho, que, por sua vez, varia com o valor da força de trabalho ou com os desvios de seu preço em relação a seu valor. Ao contrário, estando dado o preço do trabalho, o salário diário ou semanal dependerá da quantidade de trabalho diário ou semanal." (MARX, p. 615) 
