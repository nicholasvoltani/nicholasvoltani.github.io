...
![[Pasted image 20250404164003.png|300]]
Fonte: [Supply and demand - Wikipedia](https://en.wikipedia.org/wiki/Supply_and_demand)

A teoria econômica neoclássica consiste na descrição de [[Competição Perfeita|Mercados Perfeitamente Competitivos]] (ou seja, preços fixos), em que agentes econômicos querem maximizar sua [[Função Utilidade|Utilidade]] (consumidores) e [[Função Lucro|lucros]] ("investidores")[^1]. 

Mário Possas descreve essa escola econômica como possuindo agentes cujas *decisões* são ditadas pela maximização/otimização[^2], e cuja *atuação* perpetra-se em *equilíbrios*. Dessa forma, qualquer ação econômica *efetiva* encontra-se em algum equilíbrio, senão não representaria uma decisão ótima de algum agente (indo contra hipóteses).[^3]
...
Uma conclusão do modelo neoclássico é a [[Lei de Say]]: a renda agregada $Y$ divide-se em consumo $C$ e poupança $S$, e toda a poupança converte-se em investimentos $I$[^5], o que dita a produção do momento futuro.[^6]
...
[^4]: Há uma conclusão implícita em que o movimento ao longo do tempo, para os neoclássicos, trata-se de um *movimento de equilíbrio em equilíbrio*, tal qual a minimização da ação ($S = \int \mathcal{L}(x, \dot{x}, t) dt$) na Física: é justamente por *cada decisão instantânea ser ótima* que o movimento econômico em si "também está" em equilíbrio.
[^5]: Assume-se.
