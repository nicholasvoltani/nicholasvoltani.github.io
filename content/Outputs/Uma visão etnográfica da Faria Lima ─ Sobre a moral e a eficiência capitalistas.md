...
Ou seja, o fazer eficiente "emancipa-se" de uma necessidade por eficiência: a própria eficiência é motivação suficiente; invés de ser um meio (mais eficiente, justamente) a um fim, torna-se um fim em si mesma, uma obsessão cega[^8].
