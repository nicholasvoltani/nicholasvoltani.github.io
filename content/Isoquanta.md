...
Formalmente, temos que $q = f(K, L)$ é função de [[Força de Trabalho]] $L$ e de capital $K$. Analisamos no espaço $L-K$ ($L$ no eixo horizontal, $K$ no eixo vertical). Aqui também temos situações de [[Bens Substitutos|Substitutos Perfeitos]] e de [[Bens Complementares|Complementares Perfeitos]], em que os fatores de produção $K,L$ são análogos de [[Cesta de Bens|Cestas de Bens]].
