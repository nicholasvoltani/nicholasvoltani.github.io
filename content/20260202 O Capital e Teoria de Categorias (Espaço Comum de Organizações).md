...
up:: [[099 MOC Rascunhos|099 MOC Anotações]] // [[010 MOC Marxism]] // [[027 MOC Category Theory]]

# Preliminary remarks
Motivation: common conceptual frame to deal with *political economy* and **political organization** (!)

References:
- Yuan Yao ("Dennis"), "Phenomenology of Value" (2016) [crisiscritique.org/storage/app/media/2016-11-16/yuan-yao.pdf](https://www.crisiscritique.org/storage/app/media/2016-11-16/yuan-yao.pdf)
- Primer on Political Phenomenology (Yao and Tupinambá, 2021) [space.ideaofcommunism.com/uploads/6d94b52cd66ea6164f0f643e3d875325.pdf](https://space.ideaofcommunism.com/uploads/6d94b52cd66ea6164f0f643e3d875325.pdf)

"*Theory of social worlds*", from CSO (Common Space for Organizations/Espaço Comum de Organizações).

# Modeling
![[Pasted image 20260202190017.png|500]]

System $B$ models system $A$ if all morphisms $\alpha \in A$ can be written as
$$
\alpha = enc \,; \beta \,; dec
$$
for some $\beta$ (where $;$ is the concatenation operator in [[Category|categories]]).

The advantage that can be gained is that elements in $B$ can be [[Retrodução|retroducted]] to $A$, i.e. we can ask **whether** it makes sense in $A$ as it makes sense in $B$ or not.

![[Pasted image 20260202190509.png|500]]
...
![[Pasted image 20260202191316.png|300]]
...
![[Pasted image 20260202195950.png|500]]
...
e(A,B) \in [0,1]
$$
![[Pasted image 20260202194343.png|200]]
...
![[Pasted image 20260202194756.png|300]]
...
![[Pasted image 20260202202551.png|400]]
...
![[Pasted image 20260202203943.png|400]]
...
---
### Referências
- [Espaço Comum de Organizações](https://www.instagram.com/p/DUBNKZbkdwz/?img_index=1)